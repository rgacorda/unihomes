...
function DeleteProperty({ propertyId, classNames, propertyTitle }: { propertyId: string, classNames?: string, propertyTitle: any }) {
    const [inputValue, setInputValue] = React.useState("");
    const [open, setOpen] = React.useState(false);
    const [isPending, startTransition] = React.useTransition();
    const PROJECT_NAME = propertyTitle;
            ...
            <DialogContent className={cn(classNames, "z-[999] transform translate-x-[-50%] translate-y-[-50%]")}>
                <div className="flex flex-col items-center gap-2">
                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription className="sm:text-center">
                            This action cannot be undone. To confirm, please enter the property title{" "}
                ...
                <div className="space-y-5">
                    ...
                    <DialogFooter>
                        ...
                        <Button type="button" className="flex-1" disabled={(inputValue !== PROJECT_NAME || isPending)}
                            onClick={async () => {
                                startTransition(() => {
                                    toast.promise(removePropertyById(propertyId), {
                                        ...
                                        error: (error) => {
                                            ...
                                            return "Something went wrong. Failed to delete property."
                                        },
                                    });
                                });
