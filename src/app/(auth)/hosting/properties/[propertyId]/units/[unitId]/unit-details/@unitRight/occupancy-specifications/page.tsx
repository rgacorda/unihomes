...
import { getUnitSpecifications } from "@/actions/unit/getUnitById";

import RoomSpecificationForm from "./_components/RoomSpecificationForm";

async function UnitRoomSpecificationPage({ params }: { params: { propertyId: string; unitId: string } }) {
    const data = await getUnitSpecifications(params.unitId);
    return (
                ...
                <div className="flex items-center justify-between w-full px-10 py-6 airBnbDesktop:gap-6 airBnbDesktop:w-[464px] airBnbDesktop:p-0 airBnbBigDesktop:w-[608px] min-[1128px]:w-[512px]">
                    <div className="flex justify-center items-center gap-2">
                        ...
                        <h2 className="m-0 p-0 text-[1em]">
                            <span className="p-1 px-0 text-[2rem] leading-9 tracking-[-0.04rem] font-[500]">Occupancy information</span>
                        </h2>
                    </div>
                </div>
            </header>
                ...
                <div className="airBnbDesktop:mx-auto airairBnbBigDesktop:w-[608px] min-[1128px]:w-[512px] airBnbDesktop:w-[464px]">
                    <div className="font-normal">
                        <div className="text-base leading-5 tracking-normal my-4 lg:mt-0">
                            Change your unit&apos;s occupancy information here. Click save when you&apos;re done.
                        </div>
                    </div>
                    <RoomSpecificationForm unitId={params.unitId} roomSpecifications={data} />
                </div>
            </div>
        </section>
    );
...
export default UnitRoomSpecificationPage;
