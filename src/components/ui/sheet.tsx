...
interface SheetCloseProps extends React.ComponentPropsWithoutRef<typeof SheetPrimitive.Close> {
  children?: React.ReactNode; // Allow children to customize button text
  icon?: React.ReactNode; // Allow an icon to be passed for more customization
}
...
>(({ className, children, icon, ...props }, ref) => (
    <SheetPrimitive.Close
        ...
        {...props}
    >
        {icon} {/* Render the customizable icon */}
        {children || <span className="sr-only">Close</span>} {/* Render children or default text */}
    </SheetPrimitive.Close>
));
